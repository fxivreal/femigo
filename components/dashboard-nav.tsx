...
import { Home, Library, Sparkles, User, LogOut, MessageCircle } from "lucide-react"
      ...
      <aside className="hidden md:flex md:flex-col md:fixed md:inset-y-0 md:w-60 md:border-r md:bg-background md:z-30">
        ...
        <div className="p-3 border-t">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            <div className="flex items-center justify-center size-7 rounded-full bg-primary/10 text-primary text-xs font-bold">
