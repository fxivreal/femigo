          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-1.5 flex-1 px-3 py-2 text-sm font-medium rounded-lg transition-all ${
                active
                  ? "bg-background text-[#1877F2] shadow-sm"
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <Textarea
            ...
            className="min-h-[250px] sm:min-h-[350px] resize-y focus-visible:ring-[#1877F2]/20"
            value={content}
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-3 rounded-xl border p-3.5 text-left transition-all ${
                    checked
                      ? "border-[#1877F2]/30 bg-[#1877F2]/5 shadow-sm"
                ...
                >
                  ...
                  {checked && (
                    <div className="flex items-center justify-center size-5 rounded-full bg-[#1877F2] text-white">
          ...
          <div className="bg-background rounded-xl shadow-xl w-full max-w-lg max-h-[80vh] flex flex-col animate-scale-in">
            ...
            <div className="flex-1 overflow-auto px-5 py-3">
              <Textarea
                ...
                className="min-h-[200px] resize-none text-sm focus-visible:ring-[#1877F2]/20"
              />
            </div>
