    ...
    <div className="flex min-h-screen flex-col">
      <header className="flex items-center justify-between px-4 sm:px-8 h-14 border-b bg-background/80 backdrop-blur-sm sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/signup"
            className="inline-flex h-8 items-center justify-center rounded-lg bg-primary px-4 text-sm font-medium text-white hover:bg-primary/80 transition-colors"
          >
            Get started
          </Link>
        </div>
        ...
        <section className="relative overflow-hidden px-4 pt-20 pb-24 sm:pt-28 sm:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/signup"
                className="inline-flex h-10 items-center justify-center rounded-lg bg-primary px-6 text-sm font-medium text-white hover:bg-primary/80 transition-colors gap-1.5 w-full sm:w-auto"
              >
                Get started free
